    ...
    *,
    ...
    while produced < int(max_new_tokens):
        ...
        if use_cache:
            ...
            block_hidden = block_out.hidden_states[-1][:, -len(draft_tokens) :, :]
            past_snapshot = None
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Speculative decoding with EAGLE-3 speculator (Qwen3-0.6B).")
